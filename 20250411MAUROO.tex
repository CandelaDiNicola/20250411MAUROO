...
%\title{Periodistas en Debate. Aportes al Estudio del Campo Periodístico}

%\date{2009 -- 2015}

%\author{Mauro David Dobruskin}
...
\epigraph{-¿Y si se rompe la ilusión? -dije con un hilo de voz.
	...
	\emph{Esse est percipi} (Ser es ser percibido) \parencite{@6980-BORGES1967} (Borges y Bioy Casares, 1967)}
...
Desde la reinstalación del sistema democrático, en 1984, es posible identificar el desarrollo y la consolidación de los libros de periodistas como uno de los géneros predominantes del ámbito editorial \parencite{@6993-DEDIEGO2012} (De Diego, 2014).Por otra parte, este fenómeno constituye una forma de intervención pública y de jerarquización profesional en el ámbito periodístico (Pereyra, 2013; Vommaro y Baldoni, 2012).

Baldoni y Gómez Rodríguez (2018) dan cuenta del fenómeno mostrando el proceso de incorporación de la producción de libros de periodistas en el mercado editorial, inicialmente desde las pequeñas editoriales. Luego, a partir de la consolidación de este género, las grandes casas editoriales encontraron, como muestra Saferstein (2016), un nicho de mercado propicio para la producción de \emph{bestsellers}.
...
El estudio de un campo determinado de la actividad social presenta problemas inherentes al propio campo de estudio, a la importancia y valoración que la sociedad le asigna, su volumen cuantitativo, en relación a la cantidad de sujetos que lo integran, como a su periferia, etc. \textcite[196]{@6982-BOURDIEU2008} Bourdieu (2008: 196) plantea con claridad esta cuestión cuando aborda el estudio del campo de la alta costura y considera que este espacio social posee menos protección que otros de mayor interés o de mayor \enquote{legitimidad}. Sostiene en ese trabajo que los \enquote{objetos legítimos se hallan protegidos por su legitimidad contra la mirada científica y contra el trabajo de desacralización que supone el estudio científico de los objetos sagrados} \textcite[197]{@6982-BOURDIEU2008} (Bourdieu 2008: 197).
...
La prensa ha sido durante el siglo XX uno de los fenómenos sobre los que las ciencias sociales han reflexionado de manera intensa, considerando su importancia en los sistemas democráticos y consecuentemente por su capacidad de influencia en la opinión pública y las formas que ésta adopta. Entre los temas centrales abordados por los investigadores se halla la relación entre los medios y las audiencias, habiendo quedado, en general, relegada la atención sobre el fenómeno de los periodistas, los que hacen las noticias y/o deciden sobre ellas (\emph{gatekeepers} y \emph{newsmakers}). \textcite[203]{@7065-WOLF2004} Wolf (2004: 203) observa lo tardío e importante de dichos estudios frente a las investigaciones centradas en la relación entre \emph{mass media} y opinión pública
...
Por su parte, \textcite{@6974-BELIZ1998} Beliz y Zuleta Puceiro (1998) analizan la cultura profesional del periodismo argentino, a través de una encuesta a periodistas, centrando la atención en la percepción que los periodistas tienen sobre la libertad para expresarse, pero avanzando sobre algunas consideraciones de la cultura del campo. Es de destacar que, entre las principales amenazas a la libertad de expresión, la categoría que concentró la mayor cantidad de respuestas fue \enquote{el proceso de concentración de medios de comunicación}, seguido de la \enquote{dependencia respecto a la publicidad de empresas privadas}. Ambas respuestas fueron señaladas por más del 80\% de los encuestados.
...
Unos meses más tarde, \textcite{@6967-CESAR2013} Arrueta (2012) aborda también este conflicto, poniéndole nombre a las formas de periodismo enfrentadas \rdm{\emph{periodismo corporativo} y \emph{periodismo militante}} y rastrea su historia conceptual en el país. Más adelante, continúa con esta búsqueda y aborda los aspectos identitarios del campo periodístico en el proceso de relación con las empresas de medios.
...
En \emph{Algunas propiedades de los campos}, \textcite[112]{@6983-BOURDIEU2008} Bourdieu (2008: 112) sostiene:
...
Según \textcite[IV]{@7060-VERON1987} Verón (1987: IV)
...
Según \textcite[115]{@6983-BOURDIEU2008} Bourdieu (2008: 115),
...
\begin{quote}
Creo que lo que 6 7 8 incorporó antes que nadie (y no digo que sea un rasgo positivo), fue el choque frontal con otros periodistas. Antes de 6 7 8, nadie se había metido con un periodista desde un programa de televisión. No existía la denuncia contra el medio de comunicación \parencite[72]{@7040-OLIVAN2010} (Oliván y Alabarces, 2010: 72).
\end{quote}
...
Es este un magnífico discurso legitimante de la actividad de los medios. Pero no era solo Clarín o sus periodistas los que se sentían agredidos o en medio de una guerra. Hacia el fin del período seleccionado, \textcite[8, 11]{@7037-NOVARO2015} Novaro y Birmajer (2015: 8, 11) sostienen, en \emph{Grandes y pequeñas mentiras que nos contaron}:
...
\textcite[4]{@6972-ORLANDO2011} Barone (2011: 4), uno de los expatriados, cita en su libro, \emph{K Letra bárbara. Periodismo sucio y público sublevado}, una leyenda que circula en el medio y que refleja de alguna manera a este tipo de periodista que, en general, suele destacarse en los medios dominantes:
...
\begin{quote}
Nadie podría acusar a Verbitsky de opositor. Verdadero titán del periodismo independiente durante los 90 y entendido en guerrillas setentistas, el \enquote{Perro} pasó a ser un adalid intelectual del autodefinido \enquote{kirchnerismo racional} \parencite[10]{@7067-ZUNINO2011} (Zunino, 2011: 10).
\end{quote}
...
\begin{quote}
En demasiadas ocasiones los medios se mostraron bastante cómodos ocupando un lugar de oposición que no se corresponde con su esencia: la lealtad al lector, al oyente, al televidente. También de este lado del mostrador queda mucho por aprender, revisar y corregir. \textbf{No se trata de salvar a tal o cual empresa. Hay que salvar al periodismo}. El bicentenario está a la vuelta de la esquina. Sonará estúpidamente obvio, pero el pueblo sigue queriendo saber de qué se trata, mientras los gobernantes insisten en vendérsela cambiada \parencite[280]{@7067-ZUNINO2011} (Zunino, 2011: 280).\footnote{El énfasis es propio.}
\end{quote}
...
\begin{quote}
VHM: España\footnote{Se refiere al equipo de fútbol español.} no me gustó, no me divirtió, no me entretuvo. Para relatarla, fue insoportable (Refiriéndose al Mundial del 2010, en que España se alzó con la copa) \parencite[81]{@7053-SIRVEN2013} (Sirvén, 2013: 81).
\end{quote}
...
Por si hiciera falta aclararlo, Víctor Hugo Morales, se refiere al partido que España jugó contra los Países Bajos, no a la situación política de Sudáfrica. En relación al Mundial de 1978, \textcite[82]{@7053-SIRVEN2013} Sirvén (2011: 82) encuentra entre las frases más criticables de Víctor Hugo Morales, la siguiente:
...
El gobierno dictatorial de Uruguay respalda a Morales contra una suspensión que le impuso la Asociación Uruguaya de Fútbol. \textcite[123]{@7053-SIRVEN2013} Sirvén (2013: 123) lo narra de esta manera:
...
Sigue \textcite[122]{@6978-BLAUSTEIN2013} Blaustein (2013: 122) reflexionando sobre el significado de independencia según su perspectiva:
...
\begin{quote}
Hay más, la Relatoría para la Libertad de Expresión dice que \enquote{la publicidad estatal puede compensar los vastos recursos de la comunicación controlados por intereses empresariales o por los círculos financieros, pues pueden ampliar la voz de periodistas y medios de comunicación locales, de los medios más pequeños y de los que critican a las empresas} \parencite[221]{@6978-BLAUSTEIN2013} (Blaustein, 2013: 221).
\end{quote}
...
En el párrafo siguiente \textcite[83]{@6977-BLAUSTEIN2014} Blaustein (2014: 83) afirma:
...
Dice \textcite[6-7]{@6977-BLAUSTEIN2014} Bercovich (2014: 6-7) en su prólogo:
...
\begin{quote}
Luego, con la salida de Carlos Menem del poder retomó ciertos rasgos de independencia informativa, sobre todo durante el Gobierno de Fernando de la Rúa \parencite[35]{@6971-A2014} (Bargach y Suárez, 2014: 35)\footnote{La cita se refiere a TELAM}.
\end{quote}
...
\begin{quote}
Aspiramos a que los escritos incluidos en esta obra alienten la reflexión sobre el valor de las libertades de expresión y de prensa como piedras basales del debate democrático \parencite[11]{@7015-JORNET2014} (Jornet y Dessein, 2014: 11).
\end{quote}
...
\begin{quote}
A lo largo de la investigación consultamos a casi sesenta personas, en aproximadamente setenta entrevistas personales, por correo electrónico y por Skype. No todos los entrevistados accedieron a que se conociera su nombre, y de varios de ellos quedaron pasajes que no fueron incluidos en el cuerpo de este libro. Lo que sigue es una selección de algunos de esos fragmentos \parencite[408]{@7017-LEVINAS2015} (Levinas, 2015: 408).
\end{quote}
...
Alonso, Paula (1997): \enquote{En la primavera de la historia}: el discurso político del roquismo de la década del ochenta a través de su prensa. En: Boletín del Instituto de Historia Argentina y Americana \enquote{Dr. Emilio Ravignani}, Tercera serie, N° 15, 1er. Semestre de 1997, Buenos Aires.

Alonso, Paula (2004): \enquote{La tribuna nacional y Sud-América: tensiones ideológicas en la construcción de la \enquote{Argentina moderna} en la década de 1880}. En: Construcciones impresas. Buenos Aires: Fondo de Cultura Económica.
