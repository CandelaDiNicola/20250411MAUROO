...
\usepackage[hyphenation,homeorchy,homeoarchywordcolor=orange,homeoarchywordcolor=Orange,draft]{impnattypo}
...
\subsection{1. 2. Objetivos y supuestos de la investigación}
...
\subsection{1. 3. Consideraciones preliminares}
...
\subsubsection{1. 3. 1. Cambio tecnológico y crisis de financiamiento}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.0748}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.0749}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.0749}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1098}}
...
\subsubsection{1. 3. 2. El período dorado}
...
\subsubsection{1. 3. 3. Fin de la época dorada}
...
\subsection{1. 4. Abordaje Metodológico}
...
\section{2. Estado de la cuestión y consideraciones teórico-metodológicas}

\subsection{2. 1. Antecedentes sobre la temática}
...
\alert{\textbf{\hl{La credibilidad}}

\hl{}

\hl{}

\hl{\textbf{Independencia Libertad de expresión Agenda de actualidad}}}
...
\href{http://www.cuspide.com/9789500736688/K++Letra+Barbara/}{K Letra bárbara} & Sudamericana
...
\href{http://www.cuspide.com/9789871496990/Tiempos+Turbulentos/}{Tiempos turbulentos} & Ariel /Paidós
...
\href{http://www.cuspide.com/9789870434481/Audiencia+Con+El+Diablo/}{Audiencia con el diablo} & Aguilar & 24 & ~Víctor Hugo \href{http://www.cuspide.com/resultados.aspx?c=MORALES+VICTOR+HUGO\&por=AutorEstricto\&aut=278005\&orden=fecha}{Morales} \\
...
\subsubsection{4. 2. 1. Etapa Preparatoria}
