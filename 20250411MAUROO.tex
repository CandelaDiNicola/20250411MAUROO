...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.1381}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.1309}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.1306}}@{}}
\toprule\noalign{}
...
\section{3. Descripción del campo periodístico en la Argentina, 2009 - 2015}

\subsection{3. 1. Los periodistas y el fenómeno editorial}
...
\subsection{3.2. El contexto político del conflicto en la mirada de la prensa}
...
\subsubsection{3. 3. 3. Pseudoperiodistas}

\alert{\textbf{Los emigrados}}
...
\section{4. Análisis de Contenido del \emph{Corpus} Bibliográfico}

\subsection{4.1. Corpus de Análisis}
...
\subsubsection{4. 2. 2. Periodismo de Guerra}
