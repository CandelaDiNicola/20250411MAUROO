...
\subsection{2. 2. Enfoque Conceptual}
...
\subsubsection{2. 2. 1. El campo periodístico}
...
\subsubsection{2. 2. 2. La credibilidad}
...
\subsubsection{2. 2. 3. La legitimidad del campo periodístico}
...
\subsubsection{2. 2. 4. Autonomización del campo periodístico}
...
\subsection{3. 3. Acerca del campo periodístico}
...
\subsubsection{3. 3. 1. Propuesta de clasificación de periodistas según su lugar en el campo}
...
\subsubsection{3. 3. 2. Categorías de periodistas}
